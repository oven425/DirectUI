...
namespace DirectUI
{
	namespace Control
	{
		...
		public:
			...
			CDirectUI_Thinkness(float left_right, float top_bottom) { this->m_Left = this->m_Right = left_right; this->m_Top = this->m_Bottom = top_bottom; }
			CDirectUI_Thinkness(float left, float right, float top, float bottom) { this->m_Left = left, this->m_Right = right; this->m_Top = top; this->m_Bottom = bottom; }
